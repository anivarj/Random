...
## DESCRIPTION: This script is for automating opening MAX projections from a scan folder. It will make a list of all the scans in the folder, and then find the MAXs and open them. IF YOU WANT TO OPEN A DIFFERENT DIRECTORY, CHANGE RUN_IT() TO LOOK IN A DIFFERENT FOLDER (LINE 95)
