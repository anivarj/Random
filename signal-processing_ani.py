...
plotIndividualPeaks = True      #TRUE = plots peaks for each box. 
...
for i in range(len(fileNames)):  #iterates through the .tif files in the specified directory
    ...
    if imageChannels == 2:
        ...
        meanACFDf = mergeAndSave(meanCh1ACFDf, meanCh2ACFDf, boxSavePath, save=False) #merge Ch1 and Ch2 ACF dataframes together
